...
class Board {
  ...
  * this constructor only used when one of the default options are selected
  **/
  public Board(int s) {
    if(s == EASY_SIZE) {
      mine_count = 8;
  ...
  /**
  * @param s size of board
  * @param c how many bombs to add to the board
  * this constructor is called only for the custom board option
  **/
  ...
  /**
  * Sets the mines on the board. Create an ArrayList of Integers. Add all nums from 0 to ((s^2)-1) to it. In a for loop, bounded by mine count, pick a random position in the List. Remove the position from the List and mark position as bomb.
  *
  ...
  **/
  ...
  /**
  * Goes through all the rows and columns in the board and sets the adj_mines count for all non-mine tiles
  *
